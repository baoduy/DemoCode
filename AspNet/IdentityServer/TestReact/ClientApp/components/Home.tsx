...
import { getUserManager, getSessionStorage, removeSessionStorage } from "../core/LoginApi";
        ...
        if (user) {
            getUserManager().getUser()
                .then(u => {
                    ...
                    const url = "http://localhost:2000/api/values/10";
                ...
                .catch(error => alert(`GetUser Error: ${error}`));
        } else getUserManager().signinRedirect();
    }
